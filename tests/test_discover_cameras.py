...
class TestDiscoverCameras:
    ...
    def test_discover_cameras_handles_camera_processing_exception(self):
        ...
        with patch('builtins.print') as mock_print:
            ...
            with patch('pathlib.Path') as mock_path_class:
                ...
                mock_path_instance.iterdir.side_effect = Exception("Directory iteration error")
    ...
    def test_nonexistent_input_directory(self):
        ...
        with patch('builtins.print') as mock_print:
            ...
            assert result == []
            mock_print.assert_any_call("Warning: Input directory /nonexistent does not exist")
    ...
    def test_discover_with_translation_map(self):
    ...
    def test_discover_ignores_files(self):
    ...
    def test_discover_iterdir_exception_handling(self):
        ...
        with patch('builtins.print') as mock_print:
            ...
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                with patch('sync_hikvision_cameras.Path') as mock_path_class:
                    ...
                    mock_path_instance.iterdir.side_effect = PermissionError("Permission denied")
