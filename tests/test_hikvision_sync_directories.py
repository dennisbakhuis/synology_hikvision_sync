...
class TestHikvisionSyncDirectories:
    ...
    def test_create_directories_single_camera(self) -> None:
    ...
    def test_create_directories_multiple_cameras(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            sync = HikvisionSync(
                cameras=[("src1", dst_path1, "cam1"), ("src2", dst_path2, "cam2")]
            )
    ...
    def test_create_directories_existing_dirs(self) -> None:
