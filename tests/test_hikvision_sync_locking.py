...
class TestHikvisionSyncLocking:
            ...
            with patch("fcntl.flock") as mock_flock:
                with patch("os.getpid", return_value=12345):
                    ...
                    mock_flock.assert_called_once_with(
                        sync.lock_file_descriptor, fcntl.LOCK_EX | fcntl.LOCK_NB
                    )

    def test_acquire_lock_failure_flock_exception(self) -> None:
    ...
    def test_acquire_lock_failure_file_exception(self) -> None:
    ...
    def test_release_lock_unlink_failure(self) -> None:
    ...
    def test_release_lock_no_descriptor(self) -> None:
